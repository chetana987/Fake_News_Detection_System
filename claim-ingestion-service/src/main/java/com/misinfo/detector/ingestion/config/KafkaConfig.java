...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic rawPosts() {
        return TopicBuilder.name("raw-posts").partitions(3).replicas(1).build();
    }

    @Bean
    public NewTopic claimsExtracted() {
        return TopicBuilder.name("claims-extracted").partitions(3).replicas(1).build();
    }

    @Bean
    public NewTopic evidenceRetrieved() {
        return TopicBuilder.name("evidence-retrieved").partitions(3).replicas(1).build();
    }
    ...
    @Bean
    public NewTopic rawPostsDlt() {
        return TopicBuilder.name("raw-posts.DLT").partitions(3).replicas(1).build();
    }
